...
# KINECT PARAMS
KINECT_RESOLUTION = ColorResolution.RES_720P
...
AUDIO_MICROPHONE_DEVICE_INDEX = 0
AUDIO_MICROPHONE_CHUNK_SIZE = 512
AUDIO_MICROPHONE_RECORDING_TIME = 15 # in seconds
